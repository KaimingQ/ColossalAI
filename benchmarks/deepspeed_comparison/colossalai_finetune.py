...
# -*- coding: utf-8 -*-
"""
ColossalAI Fine-Tuning Benchmark Script (Full Parameter SFT & LoRA PEFT)
...
from colossalai.booster.plugin import TorchFSDPPlugin, TorchDDPPlugin
...
def parse_args():
    ...
    p.add_argument("--plugin", type=str, default="fsdp", choices=["fsdp", "ddp"])
...
def main():
    ...
    # ---------- Plugin & Booster ----------
    if args.plugin == "ddp" or args.mode == "lora":
    ...
    for step in range(args.steps):
        ...
        # 6N TFLOPS standard estimation for causal LM
